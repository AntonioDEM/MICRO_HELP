...
class AboutWindow:
    ...
    def _create_widgets(self):
        ...
        desc_frame = self._create_info_section(
            main_frame,
            "Descrizione",
            ["ASP - Auto Spcr for Pyinstaller è un'applicazione che permette di gestire facilmente "
                "la creazione dei file .spec ed .nsi sia per Windows che per macOS.\n"
                "Ancora in fase di sviluppo, si sta cercando il modo migliore per poter eseguire anche la\n"
                "copilazione automatica dei file .spec"]
        )
